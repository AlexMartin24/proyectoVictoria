...
import { ProductListComponent } from '../../../../manager/products/product-list/product-list.component';
import { Product } from '../../../../manager/products/model/product.model';
import { Subscription } from 'rxjs';
import { ProductDialogService } from '../../../../manager/products/services/product-dialog.service';
import { ProductService } from '../../../../manager/products/services/product.service';
import { DialogService } from '../../../../core/services/dialog.service';
import { ProductDialogComponent } from '../../../../manager/products/product-dialog/product-dialog.component';

@Component({
  selector: 'app-product-page',
  standalone: true,
  imports: [SharedModule, ProductListComponent, ProductDialogComponent],
...
export class ProductPageComponent implements OnInit, OnDestroy {
  ...
  /** Crear producto */
  onCreate() {
    this.productDialogService.openProductDialog({ mode: 'create' })
  ...
  onEdit(product: Product) {
    console.log('PADRE onEdit recibido', product); // <-- nunca se muestra?
